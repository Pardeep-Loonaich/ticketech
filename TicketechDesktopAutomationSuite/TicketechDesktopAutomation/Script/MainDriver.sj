...
===================================================================*/
  ...
  try { 
    ...
    DataPool.FileName = "PosXmlConfig.xls";
    DataPool.SheetName = "Garage";
    GarageData = DataPool.New(); 
  
    while (!DataPool.EOF){
      if(DataPool.Item("Run") == "Yes"){ 
        var locID = DataPool.Item("LocationID");
        Indicator.PushText("LocID#" + DataPool.Item("LocationID"));
        var locGUID = DataPool.Item("LocationGUID");
        Indicator.PushText("LocGUID#" + DataPool.Item("LocationGUID"));
        ConfigUtility.SelectGarage(locID, locGUID);                          
