...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~----~~~~~~~~
  TC_PIN_EMP_002 : Validating Employee PunchOut Time by providing invalid emp ID
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~---~~~~~~*/
  ...
  var expectedErrorMessage = "YOU ARE ALREADY PUNCHED OUT AT 01/31/17 01:22PM"; //Stores the expected error message    
  ...
  while (!DataPool.EOF) {
    ...
    try {
     ...
     //Step-2: Navigate into Employee info screen and submit invalid emp ID
      //--------------------------------------------------------------------
      home.NavigateToEmployeePunchOutScreen();
